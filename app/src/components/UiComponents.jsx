...
import { Search, X, Download, ChevronLeft, ChevronRight, ChevronsLeft, ChevronsRight } from 'lucide-react';
          ...
          <div ref={scrollRef} className="overflow-x-auto rounded-xl border border-line" tabIndex={0} aria-label="Data table, scroll horizontally for more columns">
            <table className="w-full text-left text-sm">
              <thead className="bg-canvas-soft text-ink-muted font-medium sticky top-0">
                <tr>
                  {columns.map((col) => (
                    <th key={col.accessor || col.header} className="px-4 py-3 whitespace-nowrap select-none">
                      {col.header}
                    </th>
                  ))}
                </tr>
                  ...
                  >
                    {columns.map((col) => (
                      <td
                        ...
                        className={col.align === 'right' ? 'px-4 py-3 text-ink text-right' : 'px-4 py-3 text-ink'}
                      >
...
export function PlaceholderScreen({ title, description }) {
  return (
    <div className="flex flex-col items-center justify-center py-20">
      <div className="w-16 h-16 rounded-2xl bg-canvas-soft border border-line flex items-center justify-center mb-5">
